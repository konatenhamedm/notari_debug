...
class DefaultController extends AbstractController
{
    ...
    public function frais()
    {
     ...
     /**
     * @Route("/print-iframe", name="default_print_iframe", methods={"DELETE", "GET"}, condition="request.query.get('r')", options={"expose"=true})
     */
    public function defaultPrintIframe(Request $request, UrlGeneratorInterface $urlGenerator)
    {
        ...
        return $this->render('_admin/print_iframe.html.twig', [
