...
class UserController extends AbstractController
{
                          ...
                          UserRepository $userRepository): Response
    {
        ...
        $renders = [
            ...
            'password' =>  new ActionRender(function () {
                return true;
            }),
                ...
                , 'render' => function ($value, $context) use ($renders) {
                    ...
                    $options = [
                        ...
                        'actions' => [
                            ...
                            'password' => [
                                'url' => $this->generateUrl('edit_password', ['id' => $value])
                                , 'ajax' => true
                                , 'icon' => '%icon% fe fe-edit'
                                , 'attrs' => ['class' => 'btn-default','title'=>'Modifier le mot de passe']
                                , 'render' => new ActionRender(function () use ($renders) {
                                    return $renders['password'];
                                })
                            ],
                        ]
                    ];
        ...
        return $this->render('_admin/user/index.html.twig', ['datatable' => $table, 'titre' => 'Liste des utilisateurs']);
    }
    ...
    /**
     * @Route("/user/{id}/edit_password", name="edit_password", methods={"GET","POST"})
     */
    public function editPassword(Request $request,User $user, EntityManagerInterface  $em,FormError $formError): Response
    {

        $form = $this->createForm(UserEditPasswordType::class,$user, [
            'method' => 'POST',
            'action' => $this->generateUrl('edit_password',[
                'id'=>$user->getId(),
            ])
        ]);
        $form->handleRequest($request);
