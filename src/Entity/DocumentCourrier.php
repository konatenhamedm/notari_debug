...
/**
 * @ORM\Entity(repositoryClass=DocumentCourrierRepository::class)
 */
class DocumentCourrier
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=CourierArrive::class, inversedBy="documentCourriers")
     * @ORM\JoinColumn(nullable=false)
     */
    private $courier;
